...
- **Endpoint URL:** `https://eltx.online/stripe/webhook` (replace the domain if you are configuring a staging environment).
...
2. Set the **Endpoint URL** to `https://eltx.online/stripe/webhook`.
