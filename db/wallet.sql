...
CREATE TABLE IF NOT EXISTS wallet_withdrawals (
  ...
  net_amount_wei DECIMAL(65,0) NOT NULL DEFAULT 0,
...
ALTER TABLE wallet_withdrawals
  ...
  ADD COLUMN IF NOT EXISTS fee_bps INT UNSIGNED NOT NULL DEFAULT 0 AFTER amount_wei,
  ADD COLUMN IF NOT EXISTS fee_wei DECIMAL(65,0) NOT NULL DEFAULT 0 AFTER fee_bps,
  ADD COLUMN IF NOT EXISTS net_amount_wei DECIMAL(65,0) NOT NULL DEFAULT 0 AFTER fee_wei,
  ADD COLUMN IF NOT EXISTS chain VARCHAR(32) NOT NULL AFTER net_amount_wei,
...
-- platform fee balances (premium subscriptions, etc.)
...
ALTER TABLE platform_fee_balances
  ADD COLUMN IF NOT EXISTS fee_type VARCHAR(64) NOT NULL FIRST,
  ADD COLUMN IF NOT EXISTS asset VARCHAR(32) NOT NULL AFTER fee_type,
  ADD COLUMN IF NOT EXISTS amount_wei DECIMAL(65,0) NOT NULL DEFAULT 0 AFTER asset,
  ADD COLUMN IF NOT EXISTS updated_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP AFTER amount_wei;
...
INSERT IGNORE INTO platform_settings (name, value) VALUES ('email_user_withdrawal_enabled', '1');
INSERT IGNORE INTO platform_settings (name, value) VALUES ('email_admin_withdrawal_enabled', '1');
...
ALTER TABLE ai_daily_usage
  ADD COLUMN IF NOT EXISTS messages_used INT UNSIGNED NOT NULL DEFAULT 0 AFTER usage_date,
  ADD COLUMN IF NOT EXISTS paid_messages INT UNSIGNED NOT NULL DEFAULT 0 AFTER messages_used,
  ADD COLUMN IF NOT EXISTS eltx_spent_wei DECIMAL(65,0) NOT NULL DEFAULT 0 AFTER paid_messages,
  ADD COLUMN IF NOT EXISTS last_message_at DATETIME NULL AFTER eltx_spent_wei,
  ADD COLUMN IF NOT EXISTS created_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP AFTER last_message_at,
  ADD INDEX IF NOT EXISTS idx_ai_usage_date (usage_date);
...
ALTER TABLE ai_message_ledger
  ...
  ADD COLUMN IF NOT EXISTS amount_wei DECIMAL(65,0) NOT NULL AFTER asset,
  ADD COLUMN IF NOT EXISTS created_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP AFTER amount_wei,
  ADD INDEX IF NOT EXISTS idx_ai_ledger_user_date (user_id, usage_date),
