...
export const dict = {
  en: {
    ...
    wallet: {
      ...
      withdrawalPage: {
        ...
        subtitle: 'Request to move ELTX on-chain. Admins review every request before releasing.',
        rules: [
          ...
          'We only support ELTX balance. Requests reduce your balance immediately.',
        ],
        balanceLabel: 'Available ELTX',
        form: {
          amount: 'Amount (ELTX)',
          chain: 'Blockchain',
  ...
  ar: {
    ...
    wallet: {
      ...
      withdrawalPage: {
        badge: 'سحب ELTX أون-تشين',
        title: 'طلب سحب يدوي على البلوكتشين',
        subtitle: 'قدّم طلب سحب ELTX واحنا هنراجع ونصرفه يدوي.',
        rules: [
          ...
          'السحب على رصيد ELTX فقط، والمبلغ بيتخصم فور تسجيل الطلب.',
        ],
        balanceLabel: 'رصيد ELTX المتاح',
        form: {
          amount: 'المبلغ (ELTX)',
          chain: 'الشبكة',
