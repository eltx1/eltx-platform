    ...
    wallet: {
      ...
      withdrawalPage: {
        ...
        rules: [
          ...
          'Withdrawals are allowed 24 hours after your last successful Stripe purchase.',
          'We support ELTX and USDT balances. Requests reduce your balance immediately.',
        ...
        refresh: 'Refresh',
        lastPurchaseRequired: 'Need help? Make sure you have a successful Stripe purchase older than 24 hours.',
    ...
    wallet: {
      ...
      withdrawalPage: {
        ...
        rules: [
          ...
          'السحب متاح بعد 24 ساعة من آخر عملية شراء Stripe ناجحة.',
          'السحب متاح على رصيد ELTX و USDT، والمبلغ بيتخصم فور تسجيل الطلب.',
        ...
        refresh: 'تحديث',
        lastPurchaseRequired: 'لو فيه مشكلة تأكد إن عندك عملية Stripe ناجحة بقالها أكتر من 24 ساعة.',
