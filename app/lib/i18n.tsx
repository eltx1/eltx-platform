...
export const dict = {
  en: {
    ...
    p2p: {
      ...
      empty: 'No offers available for these filters right now.',
      tradeSide: {
        buy: 'Buy',
        sell: 'Sell',
      },
      ...
      createOffer: {
        ...
        totalAmount: 'Total asset amount',
        minLimit: 'Minimum limit (fiat)',
        maxLimit: 'Maximum limit (fiat)',
        paymentMethods: 'Payment methods',
      },
      trades: {
        kicker: 'Orders',
        title: 'My P2P trades',
        empty: 'No trades yet. Start by matching an offer.',
        order: 'Order',
      },
      chat: {
        title: 'Order chat',
        empty: 'Start the conversation with your counterparty.',
        placeholder: 'Type a message...',
        send: 'Send',
      },
      dispute: {
        prompt: 'Tell us why you are opening a dispute.',
        availableAt: 'Dispute available after',
      },
      errors: {
        missingOfferFields: 'Fill in all offer details before publishing.',
        missingPaymentMethods: 'Select at least one payment method.',
        missingTradeAmount: 'Enter the fiat amount you want to trade.',
      },
      toasts: {
        ...
        disputeOpened: 'Dispute opened. Our team will review.',
      },
      info: {
  ...
  ar: {
    ...
    p2p: {
      ...
      empty: 'مافيش عروض مناسبة للفلاتر دي دلوقتي.',
      tradeSide: {
        buy: 'شراء',
        sell: 'بيع',
      },
      ...
      stats: {
        ...
        status: 'الحالة',
        order: 'الأوردر',
        tradeAmount: 'قيمة الصفقة',
        defaultOrderTime: '15 دقيقة',
      },
      actions: {
        buy: 'شراء',
        sell: 'بيع',
        myTrades: 'أوامري',
        createOffer: 'اعمل عرض',
      ...
      createOffer: {
        ...
        asset: 'العملة',
        price: 'سعر العملة',
        totalAmount: 'إجمالي الكمية',
        minLimit: 'حد أدنى (عملة ورقية)',
        maxLimit: 'حد أقصى (عملة ورقية)',
        paymentMethods: 'وسائل الدفع',
      },
      trades: {
        kicker: 'الأوامر',
        title: 'صفقاتي في P2P',
        empty: 'لسه مافيش صفقات. اختار عرض وابدأ.',
        order: 'الأوردر',
      },
      chat: {
        title: 'شات الصفقة',
        empty: 'ابدأ المحادثة مع الطرف الآخر.',
        placeholder: 'اكتب رسالتك...',
        send: 'إرسال',
      },
      dispute: {
        prompt: 'قول سبب فتح النزاع.',
        availableAt: 'النزاع متاح بعد',
      },
      errors: {
        missingOfferFields: 'اكتب كل تفاصيل العرض قبل النشر.',
        missingPaymentMethods: 'اختار وسيلة دفع واحدة على الأقل.',
        missingTradeAmount: 'اكتب قيمة الصفقة بالعملة الورقية.',
      },
      toasts: {
        offerCreated: 'تم إنشاء العرض بنجاح.',
        tradeCreated: 'تم إنشاء الصفقة بنجاح.',
        markedPaid: 'تم تعليم الدفع.',
        released: 'تم تحرير الرصيد للمشتري.',
        completed: 'تم إكمال الصفقة.',
        disputeOpened: 'تم فتح نزاع وهيتم المراجعة.',
      },
      info: {
