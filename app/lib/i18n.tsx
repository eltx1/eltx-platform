...
export const dict = {
  en: {
    ...
    wallet: {
      ...
      withdrawalPage: {
        ...
        title: 'Manual on-chain withdrawal',
        ...
        rules: [
          ...
          'A withdrawal fee is deducted from the requested amount.',
        ],
        balanceLabel: 'Available balance',
        selectedAsset: 'Selected',
        requestedLabel: 'Requested amount',
        feeLabel: 'Withdrawal fee',
        feeNotice: 'We deduct a {fee} fee from the requested amount.',
  ...
  ar: {
    ...
    wallet: {
      ...
      withdrawalPage: {
        badge: 'سحب أون-تشين',
        title: 'طلب سحب يدوي على البلوكتشين',
        subtitle: 'قدّم طلب سحب ELTX أو USDT واحنا هنراجع ونصرفه يدوي.',
        rules: [
          ...
          'فيه رسوم سحب بتتخصم من المبلغ المطلوب.',
        ],
        balanceLabel: 'الرصيد المتاح',
        selectedAsset: 'مُختار',
        requestedLabel: 'المبلغ المطلوب',
        feeLabel: 'رسوم السحب',
        feeNotice: 'بنخصم {fee} من المبلغ المطلوب وقت إنشاء الطلب.',
